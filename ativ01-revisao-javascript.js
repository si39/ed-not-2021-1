...
/*
   3) Percorra o vetor estadosNe usando um for tradicional. 
      Para cada estado, chame a arrow function criada em 2) e efetue o cálculo correspondente.
      Com o resultado do cálculo, crie uma propriedade chamada 'densidade demográfica' para cada objeto,
...
/* 4) Escreva uma arrow function que receba um objeto. 
      Na função, use for..in para extrair as propriedades e seus valores e exibi-los com console.log().

*/

const nomesEstado = estado => {
...
// Sergipe => adicionado com push(), 
nomesUf.push('Sergipe')

// Alagoas =>  unshift() para vir antes de Alagoas
nomesUf.unshift('Alagoas')

// Rio Grande do Norte => com splice(), entre os dois já existentes
nomesUf.splice(1, 0, 'Rio Grande do Norte')

// Paraíba => com splice(), antes de Rio Grande do Norte
nomesUf.splice(2, 0, 'Paraíba')

// Pernambuco => com splice(), antes de Sergipe
nomesUf.splice(3, 0, 'Pernambuco')

// Ceará => com splice(), antes de Rio Grande do Norte
nomesUf.splice(1, 0, 'Ceará')

// Piauí => com splice(), antes de Sergipe
nomesUf.splice(5, 0, 'Piauí')

// Maranhão => com splice(), antes de Rio Grande do Norte
nomesUf.splice(2, 0, 'Maranhão')

// Bahia => com splice(), antes de Ceará
